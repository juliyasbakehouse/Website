        ...
        <div className="grid gap-10 md:grid-cols-2 md:gap-16">
          <Reveal>
            <div className="relative overflow-hidden rounded-[2rem]">
              ...
              {item.tag && (
                <span className="absolute left-4 top-4 rounded-full bg-(--color-bg)/85 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-(--color-gold-bright) backdrop-blur">
                  {item.tag}
                </span>
              )}
            </div>
