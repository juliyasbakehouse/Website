...
export default function Hero() {
  return (
    <section className="relative flex flex-col bg-(--color-bg) md:min-h-dvh md:flex-row md:items-center md:gap-8 md:px-6 lg:px-12">
      <div className="relative h-[56vh] shrink-0 overflow-hidden md:h-[62vh] md:max-h-[620px] md:w-[45%] md:rounded-[2rem] md:mask-b-from-70% md:mask-r-from-75%">
        <img
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-4/5 bg-gradient-to-t from-(--color-bg) via-(--color-bg)/80 to-transparent md:hidden" />
      ...
      <div className="relative z-10 -mt-64 px-6 pb-16 md:mt-0 md:flex md:flex-1 md:items-center md:px-4 md:py-14 lg:px-6">
